...
const imagenSlider = [
  {
    images1: "./assets/img/women.jpg",
    images2: "./assets/img/women2.jpg",
    images3: "./assets/img/women3.jpg",
    images4: "./assets/img/women4.jpg",
  },
];
...
const mensClothingProducts = getProductsByCategory("women's clothing");
...
//    title: "Buzo ",
//    price: 100.85,
//    description: "Lana largos",
//    category: "women's clothing",
//    image: "https://http2.mlstatic.com/D_NQ_NP_800273-CBT53084000543_122022-V.jpg",
//    rating: {
//      rate: 4.7,
//      count: 130,
//    },
...
//    category: "women's clothing",
//    image: "https://quest.vteximg.com.br/arquivos/ids/408145-676-676/QUE210220020-320-1.jpg?v=638019789522470000",
//      rate: 3.8,
//      count: 679,
//    },
//    {
...
//                <img src=${item.image} class="card-img-top image-product" alt=${item.title}>
//                 <div class="card-body">
//                    <h5 class="card-title">${item.title}</h5>
//                     <p class="card-text">${item.description}</p>
//                     <p class="price-price-mobile">$ ${item.price}</p>
//                     <button id="button-counter-${item.id}" class="btn btn-primary button-add">Agregar</button>
//                 </div>
//             </div>
//         `;
//    containerProducts.appendChild(elementitem);
//  });
// };
// renderProducts(itemProducts);
